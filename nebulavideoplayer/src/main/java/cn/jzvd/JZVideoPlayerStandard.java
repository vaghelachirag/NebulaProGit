...
public class JZVideoPlayerStandard extends JZVideoPlayer {
    ...
    public AVLoadingIndicatorView loadingProgressBarDot;
    ...
    public void init(Context context) {
        ...
        loadingProgressBarDot = findViewById(R.id.aviLoading);
    ...
    public void changeStartButtonSize(int size) {
        ...
        lp = loadingProgressBarDot.getLayoutParams();
        lp.height = size;
        lp.width = size;
    }
    ...
    public void onStatePreparingChangingUrl(int urlMapIndex, int seekToInAdvance) {
        ...
        loadingProgressBarDot.setVisibility(VISIBLE);
    ...
    public void setAllControlsVisiblity(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        loadingProgressBarDot.setVisibility(loadingPro);
