...
public class MyDownlinePlacementAdapter extends BaseAdapter implements Filterable {

    Activity activity;
    ValueFilter valueFilter;

    private ArrayList<IBOListDetails> arrayListPlacementTreeList = new ArrayList<>();
    ArrayList<IBOListDetails> mStringFilterList = new ArrayList<>();
    ArrayList<IBOListDetails> mStringFilterListid = new ArrayList<>();

    public MyDownlinePlacementAdapter(Activity activity, ArrayList<IBOListDetails> PlacementTreeLists) {
        this.activity = activity;
        arrayListPlacementTreeList.clear();
        arrayListPlacementTreeList.addAll(PlacementTreeLists);
        // mStringFilterListid.addAll(PlacementTreeLists);
        // mStringFilterList=PlacementTreeLists;
        // mStringFilterListid=PlacementTreeLists;
        mStringFilterList.addAll(PlacementTreeLists);
        mStringFilterListid.addAll(PlacementTreeLists);
    ...
    @Override
    public int getCount() {
        return arrayListPlacementTreeList.size();
    }

    @Override
    public Object getItem(int position) {
        return arrayListPlacementTreeList.get(position);
    }

    @Override
    public long getItemId(int position) {
        return arrayListPlacementTreeList.indexOf(getItem(position));
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (position < arrayListPlacementTreeList.size()) {
            if (position % 2 == 1) {
            ...
            //final PlacemenTreeValues placemenTreeValues = countrylist.get(position);

            /*holder1.legtxt.setText(placemenTreeValues.getleg());
            holder1.memberid.setText(placemenTreeValues.getmemberId());
            holder1.membername.setText(placemenTreeValues.getmemberName());
            holder1.rank_.setText(placemenTreeValues.getrank());*/

            holder1.legtxt.setText(String.valueOf(arrayListPlacementTreeList.get(position).getLeg()));
            holder1.memberid.setText(arrayListPlacementTreeList.get(position).getIBOID());
            holder1.membername.setText(arrayListPlacementTreeList.get(position).getIBOUser());
            holder1.rank_.setText(arrayListPlacementTreeList.get(position).getRank());
            holder1.lnMyDownline.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    /*holder2.leveltxt.setText(placemenTreeValues.getlevel());
                    holder2.mob.setText(placemenTreeValues.getmobile());
                    holder2.mail.setText(placemenTreeValues.getemail());
                    holder2.date.setText(placemenTreeValues.getjoiningDate());
                    holder2.gbv_.setText(placemenTreeValues.getgbv());
                    holder2.bv_.setText(placemenTreeValues.getbvP());*/
                    try {
                        holder2.leveltxt.setText(String.valueOf(arrayListPlacementTreeList.get(position).getLevelNo().toString()));
                        holder2.city.setText(arrayListPlacementTreeList.get(position).getCity());
                        holder2.mob.setText(arrayListPlacementTreeList.get(position).getMobile());
                        holder2.mail.setText(arrayListPlacementTreeList.get(position).getEmail());
                        holder2.date.setText(SetGmtTime(arrayListPlacementTreeList.get(position).getDOJ()));
                        holder2.gbv_.setText(String.valueOf(arrayListPlacementTreeList.get(position).getGBV().toString()));
                        holder2.bv_.setText(Double.toString(arrayListPlacementTreeList.get(position).getBVPercent()));
                        dialog1.show();
    ...
    private class ValueFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint != null && constraint.length() > 0) {
               ...
               /* HashSet<IBOListDetails>  hashSet = new HashSet<IBOListDetails>();
                hashSet.addAll(filterList);
                filterList.clear();
                filterList.addAll(hashSet);*/
                Set<IBOListDetails> set = new HashSet<>(arrayListPlacementTreeList);
                arrayListPlacementTreeList.clear();
                arrayListPlacementTreeList.addAll(set);

                for (IBOListDetails item : arrayListPlacementTreeList) {
                ...
                //for (int i = 0; i < mStringFilterList.size(); i++) {
                    /*if ((mStringFilterList.get(i).getIBOUser().toUpperCase())
                        ...
                        IBOListDetails PlacementTreeList = new IBOListDetails(mStringFilterList.get(i).getIBOID(),
                        ...
                        filterList.add(PlacementTreeList);
                    }*/

                    /*if ((mStringFilterList.get(i).getIBOID().toUpperCase())
                            .contains(constraint.toString().toUpperCase())) {

                        IBOListDetails placemenTreeValues2 = new IBOListDetails(mStringFilterListid.get(i).getIBOID(),
                        ...
                        filterList.add(placemenTreeValues2);
                    }*/
                //}
        ...
        protected void publishResults(CharSequence constraint,
            ...
            arrayListPlacementTreeList = (ArrayList<IBOListDetails>) results.values;
