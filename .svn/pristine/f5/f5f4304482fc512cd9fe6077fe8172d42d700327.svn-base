...
public class ShowcaseView extends RelativeLayout
    ...
    protected ShowcaseView(Context context, AttributeSet attrs, int defStyle, boolean newStyle) {
        ...
        mEndButton = (MyButton) LayoutInflater.from(context).inflate(R.layout.showcase_button, null);
        if (newStyle) {
            showcaseDrawer = (ShowcaseDrawer) new NewShowcaseDrawer(getResources(), context.getTheme());
        } else {
            showcaseDrawer = (ShowcaseDrawer) new StandardShowcaseDrawer(getResources(), context.getTheme());
        }
    ...
    private void init() {
        ...
        if (mEndButton.getParent() == null) {
           ...
           // lps.addRule(RelativeLayout.CENTER_IN_PARENT);
            ...
            lps.setMargins(margin,450,margin,margin);
            mEndButton.setLayoutParams(lps);
            mEndButton.setText(R.string.okay);
    ...
    public static class Builder {
        ...
        public Builder withHoloShowcase() {
            return setShowcaseDrawer((ShowcaseDrawer) new StandardShowcaseDrawer(activity.getResources(), activity.getTheme()));
        }
        ...
        public Builder withNewStyleShowcase() {
            return setShowcaseDrawer((ShowcaseDrawer) new NewShowcaseDrawer(activity.getResources(), activity.getTheme()));
        }
        ...
        public Builder withMaterialShowcase() {
            return setShowcaseDrawer((ShowcaseDrawer) new MaterialShowcaseDrawer(activity.getResources()));
        }
         ...
         */
        public Builder replaceEndButton(MyButton button) {
        ...
        public Builder replaceEndButton(int buttonResourceId) {
            ...
            return replaceEndButton((MyButton) view);
        }
    ...
    private void setEndButton(MyButton button) {
    ...
    private void updateStyle(TypedArray styled, boolean invalidate) {
       ...
       // String buttonText = styled.getString(R.styleable.ShowcaseView_sv_buttonText);
        ...
        mEndButton.setAllCaps(false);
        if (TextUtils.isEmpty(buttonText)) {
            buttonText = getResources().getString(R.string.okay);
