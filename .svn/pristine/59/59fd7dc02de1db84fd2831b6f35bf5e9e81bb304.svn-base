...
public class StarClubIncomeAdapter extends BaseAdapter {
  //  private static ArrayList date, rank, share_amount, total_amount, tds, net_amount, shares;
    Activity activity;
    private ArrayList<StarClubIncomeList> arrayListStarClubIncomeList = new ArrayList<>();
    public StarClubIncomeAdapter(Activity activity, ArrayList<StarClubIncomeList> StarClubIncomeLists) {
        super();
        this.activity = activity;
        arrayListStarClubIncomeList.clear();
        arrayListStarClubIncomeList.addAll(StarClubIncomeLists);
    }

    @Override
    public int getCount() {
        return arrayListStarClubIncomeList.size();
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(position < arrayListStarClubIncomeList.size()) {
            /*if(position %2 == 1)
            {
            ...
            holder1.dt.setText(SetGmtTime(arrayListStarClubIncomeList.get(position).getDate()));
            holder1.rnk.setText(arrayListStarClubIncomeList.get(position).getRank());

            //holder1.ga.setText((activity.getResources().getString(R.string.Rs))+" "+arrayListStarClubIncomeList.get(position).getTotalIncome());
            holder1.ga.setText("" + Config.formatter.format(arrayListStarClubIncomeList.get(position).getTotalIncome()).replace(".00", "").replace("Rs.", activity.getResources().getString(R.string.Rs)));
            ...
            holder1.listIncomeDetailsLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   /* holder2.sa.setText((activity.getResources().getString(R.string.Rs))+" "+share_amount.get(position).toString());
                    ...
                    //holder2.sa.setText((activity.getResources().getString(R.string.Rs))+" "+arrayListStarClubIncomeList.get(position).getShareAmount());
                    holder2.sa.setText("" + Config.formatter.format(arrayListStarClubIncomeList.get(position).getShareAmount()).replace(".00", "").replace("Rs.", activity.getResources().getString(R.string.Rs)));

                    //holder2.td.setText((activity.getResources().getString(R.string.Rs))+" "+String.valueOf(arrayListStarClubIncomeList.get(position).getTDS()));
                    holder2.td.setText("" + Config.formatter.format(arrayListStarClubIncomeList.get(position).getTDS()).replace(".00", "").replace("Rs.", activity.getResources().getString(R.string.Rs)));

                    //holder2.net.setText((activity.getResources().getString(R.string.Rs))+" "+arrayListStarClubIncomeList.get(position).getNetAmount());
                    holder2.net.setText("" + Config.formatter.format(arrayListStarClubIncomeList.get(position).getNetAmount()).replace(".00", "").replace("Rs.", activity.getResources().getString(R.string.Rs)));

                    holder2.shr.setText(arrayListStarClubIncomeList.get(position).getShares().toString());
