...
import com.nebulacompanies.ibo.adapter.CustomerAchieverAdapter;
...
public class CustomerAchieverFragment extends Fragment {
    ...
    private ArrayList<AchieverIncomeList> achievercIncome = new ArrayList<>();
    private ArrayList<AchieverclosingIncomeIBODetails> achieverclosingIncomeIBODetails = new ArrayList<>();
    CustomerAchieverAdapter customerAchieverAdapter;
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            if (achievercIncomeDetails.size() > 0) {
                customerAchieverAdapter = new CustomerAchieverAdapter(getActivity(), achievercIncomeDetails, achieverclosingIncomeIBODetails, achieverclosingIncomeIBODetails);
                listView.setAdapter(customerAchieverAdapter);
                customerAchieverAdapter.notifyDataSetChanged();
            } else {
