...
package com.nebulacompanies.ibo.showcaseview.swipe;
...
import com.nebulacompanies.ibo.showcaseview.swipe.shapes.Circle;
import com.nebulacompanies.ibo.showcaseview.swipe.shapes.RoundRect;
...
public final class TutoShowcase {
    ...
    private TutoShowcase(@NonNull Activity activity) {
        this.sharedPreferences = activity.getSharedPreferences(PrefUtils.prefTuto, Context.MODE_PRIVATE);
