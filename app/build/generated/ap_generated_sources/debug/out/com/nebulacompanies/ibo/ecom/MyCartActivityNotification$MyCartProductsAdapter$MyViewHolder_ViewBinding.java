...
public class MyCartActivityNotification$MyCartProductsAdapter$MyViewHolder_ViewBinding implements Unbinder {
  private MyCartActivityNotification.MyCartProductsAdapter.MyViewHolder target;

  @UiThread
  public MyCartActivityNotification$MyCartProductsAdapter$MyViewHolder_ViewBinding(
      MyCartActivityNotification.MyCartProductsAdapter.MyViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MyCartActivityNotification.MyCartProductsAdapter.MyViewHolder target = this.target;
