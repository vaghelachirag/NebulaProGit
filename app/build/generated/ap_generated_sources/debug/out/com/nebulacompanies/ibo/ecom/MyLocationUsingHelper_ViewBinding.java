...
public class MyLocationUsingHelper_ViewBinding implements Unbinder {
  ...
  @UiThread
  public MyLocationUsingHelper_ViewBinding(MyLocationUsingHelper target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MyLocationUsingHelper_ViewBinding(MyLocationUsingHelper target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MyLocationUsingHelper target = this.target;
