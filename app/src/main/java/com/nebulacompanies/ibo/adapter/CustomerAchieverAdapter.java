...
public class CustomerAchieverAdapter extends BaseAdapter {
    ...
    public CustomerAchieverAdapter(Activity activity, ArrayList<AchieverIncomeList> achieverIncomeDetails_, ArrayList<AchieverclosingIncomeIBODetails> achieverclosingIncomeIBODetails_,
            ...
            holder1.linearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for(int j = 0; j< details.size(); j++){
                        if(masterId == details.get(j).getHolidayAchieveIBOMasterID() && details.get(j).getCustomerType().equals("Customer")){
