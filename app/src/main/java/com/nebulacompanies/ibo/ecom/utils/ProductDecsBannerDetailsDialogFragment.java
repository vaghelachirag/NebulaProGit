...
public class ProductDecsBannerDetailsDialogFragment extends BottomSheetDialogFragment
   ...
   // ProgressDialog mProgressDialog;
    ...
    public static ProductDecsBannerDetailsDialogFragment newInstance() {
        return new ProductDecsBannerDetailsDialogFragment();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        pinCodeAdapter = new PinCodeAdapter( addressDataList, getActivity(), new PinCodeAdapter.ItemListener() {
            ...
            public void onItemClick(AddressModel addressDataList) {
                if (addressDataList != null) {
                    ...
                    isAddressType =false;
               //    ((ProductDescriptionBanner) getActivity()).setSelectedLocation( addressType,allCityID,alldata,isAddressType,cityFacilityValue );
        ...
        pickUpAddressAdapter = new PickUpAddressAdapter( pickUpAddressModels, getActivity(), new PickUpAddressAdapter.ItemListener() {
            ...
            public void onItemClick(PickUpAddressModel addressDataList) {
                ...
                //    ((ProductDescriptionBanner) getActivity()).setSelectedLocation( addressType,allCityIDPickUp,allPickUpData,isAddressType ,cityFacilityValue);
