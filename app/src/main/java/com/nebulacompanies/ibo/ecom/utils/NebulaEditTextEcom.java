...
public class NebulaEditTextEcom extends androidx.appcompat.widget.AppCompatEditText {

    public Object addTextChangedListener;
    ...
    public NebulaEditTextEcom(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public NebulaEditTextEcom(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NebulaEditTextEcom(Context context) {
        super(context);
        init();
    }
