...
public class ProductDetailsCategoryDialogFragment extends BottomSheetDialogFragment
   ...
   // String name, city, pincode, alldata,address,state,id;
    Integer cityID, allCityID,cityIDPickUp,allCityIDPickUp;
    String name, city, pincode, alldata,address,state,addressType,cityFacilityValue,cityFacility;
    String allPickUpData,namePickUp;
    ...
    public static ProductDetailsCategoryDialogFragment newInstance() {
        return new ProductDetailsCategoryDialogFragment();
    }
        ...
        pinCodeAdapter = new PinCodeAdapter( addressDataList, getActivity(), new PinCodeAdapter.ItemListener() {
            ...
            public void onItemClick(AddressModel addressDataList) {
                if (addressDataList != null) {
                    ...
                    allCityID = cityID;
                    Log.e("allCityID ","allCityID "+allCityID);
                    ...
                    isAddressType =false;
                  // ((ProductDescription) getActivity()).setSelectedLocation( alldata );
                   // ((MyCategoryActivity) getActivity()).setSelectedLocation( alldata );
                 //   ((MyCategoryActivity) Objects.requireNonNull(getActivity())).setSelectedLocation( addressType,allCityID,alldata ,isAddressType,cityFacilityValue);
                    dismiss();
        ...
        pickUpAddressAdapter = new PickUpAddressAdapter( pickUpAddressModels, getActivity(), new PickUpAddressAdapter.ItemListener() {
            ...
            public void onItemClick(PickUpAddressModel addressDataList) {
                if (addressDataList != null) {
                    ...
                    isAddressType =true;
                    addressType = "PickUp";
                   // ((MyCategoryActivity) getActivity()).setSelectedLocation( addressType,allCityIDPickUp,allPickUpData,isAddressType,cityFacilityValue );
                    dismiss();
