...
public class MyTextViewEcom extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public MyTextViewEcom(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public MyTextViewEcom(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MyTextViewEcom(Context context) {
        super(context);
        init();
    }
