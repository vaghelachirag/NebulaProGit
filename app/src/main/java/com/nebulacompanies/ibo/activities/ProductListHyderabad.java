...
public class ProductListHyderabad extends AppCompatActivity {
                    ...
                    if (response.isSuccessful()) {
                        if (response.code() == 200) {
                            ...
                            if (response.body().getStatusCode() == REQUEST_STATUS_CODE_SUCCESS) {
                                ...
                                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(ProductListHyderabad.this);
                                SharedPreferences.Editor editor = prefs.edit();
                                Gson gson = new Gson();
                                String json = gson.toJson(arrayListProductMaster);
                                editor.putString("product_list_hyd", json);
                                editor.apply();
                                aavaasPhase1ListViewAdapter = new AavaasPhase1ListViewAdapter(ProductListHyderabad.this, arrayListProductMaster);
    ...
    public void LoadProductListHydData() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(ProductListHyderabad.this);
        // SharedPreferences.Editor editor = prefs.edit();
        Gson gson = new Gson();
        String json = prefs.getString("product_list_hyd", null);
