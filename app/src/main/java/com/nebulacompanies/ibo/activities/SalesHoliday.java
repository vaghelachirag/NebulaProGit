...
import com.nebulacompanies.ibo.fragments.MySalesHoliday;
...
public class SalesHoliday extends AppCompatActivity {
    ...
    void setActionBar() {
       ...
       // swipeRefreshLayout=(SwipeRefreshLayout)findViewById(R.id.swipeRefreshLayoutMyAccount);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new MySalesHoliday(), getResources().getString(R.string.my_sales));
    ...
    class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    Fragment f1 = new MySalesHoliday();
