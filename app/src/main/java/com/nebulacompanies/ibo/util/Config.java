...
import com.nebulacompanies.ibo.model.BookingForm1;
...
public class Config {
    ...
    public static int starplatinumID = 10; // change here if star rank updated
    public static boolean showSPC = false;
    public static boolean showProfileUpload = false;
...
//   public static String shareMainUrl = "https://shop.nebulacare.in/";
   ...
   public static String TESTING_API = "http://203.88.139.169:9064";
    ...
    public static BookingForm1 form = new BookingForm1();
