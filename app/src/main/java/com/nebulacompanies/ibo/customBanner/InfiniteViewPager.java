package com.nebulacompanies.ibo.customBanner;
...
public class InfiniteViewPager extends ViewPager {
    ...
    private static final int MSG_AUTO_SCROLL_NEW = 0;
    ...
    public void stopAutoScrollCustom() {
        // this.mAutoScroll = false;
        mHandler.removeMessages(MSG_AUTO_SCROLL_NEW);
    }
